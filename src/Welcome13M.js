  ...
  return (
    <div className="home">
      ...
      <div className="Physical-buttons">
        <button onClick={() => handleButtonClick('155~160')} className="button">155~160</button>
        <button onClick={() => handleButtonClick('160~165')} className="button">160~165</button>
        <div className="Physical-buttons-bottom">
        <button onClick={() => handleButtonClick('165~170')} className="button">165~170</button>
